 ...
 */
package gestaobaracacias.estiloControlador;
...
public class EstiloControlador {
    ...
    public final static String corHover = "-fx-background-color:#70e288; "
    ...
    public final static String btnMarcadoNormala ="-fx-background-color:#069b29";
